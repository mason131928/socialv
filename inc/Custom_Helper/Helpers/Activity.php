...
?>
    ...
    ?>
        ...
        <div class="activity-header-wrapper">
            <div class="activity-header">
                ...
                <?php
                //更改日期顯示 
                $timestamp = strtotime($date_recorded . ' +8 hours'); // 加上 8 小時以轉換至 GMT+8
                $date_only = date('Y-m-d', $timestamp);                
                ?>
                <?php echo  '<span class="time-since">'.$date_only.'</span>'; ?>
    ...
    function socialv_social_share()
    {
        ...
        $content = "<ul class='sharing-options'>" . apply_filters('socialv_activity_social_share_icon', $content, $url) . "</ul>";
...
<?php
    ...
    public function socialv_bpolls_is_user_allowed_polls()
  {
  ...
  function socialv_bpolls_polls_update_html()
  {
      ...
      if ($this->socialv_bpolls_is_user_allowed_polls()) {
      ?>
              ...
              <a class="bpolls-icon" href="#" title="<?php esc_attr_e('Add a poll', 'socialv'); ?>">
                  <div class="post-elements-buttons-item bpolls-html-container">
                      ...
                      <span> <?php esc_html_e("Add a poll", "socialv"); ?> </span>
                  </div>
              </a>
<?php
      }
