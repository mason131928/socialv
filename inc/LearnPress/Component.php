...
class Component implements Component_Interface, Templating_Component_Interface {
    ...
    function socialv_custom_course_item_meta_data($sections, $course) {
        ...
        $html_count    = sprintf(
            ...
            sprintf( '<div class="meta-item meta-item-lesson">%s %d %s</div>', $ico_lesson, $count_lesson, _n( 'Lesson', 'Lessons', $count_lesson ) ),
            sprintf( '<div class="meta-item meta-item-student">%s %d %s</div>', $ico_student, $count_student, _n( 'Student', 'Students', $count_student ) )
        );
      ...
      function socialv_custom_learnpress_instructor_sections($sections, $instructor)
        { 
            ...
            $sections['social']['text_html'] = ob_get_clean();
